...
2. **Ücretsiz İşletim (Zero-Gas Mode & Gas Fee Bypassing)**:
   - Uygulama işlemlerinde asla doğrudan `PRIVATE_KEY` kullanarak gas fee harcanmaz. Sadece `payoutWalletAddress` (0x06E83497F599D67447EfFfeA399cC885CEB6eEff) cüzdan adresi üzerinden para kabul edilir.
...
4. **Gelir Transferi ve Otomatik Yönlendirme**:
   - Kontrata gelen her ödeme (USDT/POL), otomatik olarak kullanıcının tanımladığı payout cüzdan adresine (`0x06E83497F599D67447EfFfeA399cC885CEB6eEff`) anlık olarak çekilir/yönlendirilir.
