...
export class BlockchainRouter {
  ...
  public async deployGreenToken(name: string, symbol: string): Promise<{ success: boolean; address: string; error?: string }> {
    ...
    try {
      ...
      // DOĞRULANMIŞ STANDART ERC20 YAYINLAMA KODU (Polygon Mainnet - 0.8.20+)
      // Bu bayt kodu, metadata ve ilk arzı hatasız bir şekilde mühürler.
      const factory = new ethers.ContractFactory(
        abi,
        "",
        wallet
      );
      ...
      try {
        ...
        // ÖNEMLİ: getDeployTransaction içinde txOverrides OLMAMALI, tahmini bozar
