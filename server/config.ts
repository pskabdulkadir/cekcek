...
console.log("DEBUG: AQUARIUS_URL:", process.env.METADATA_CACHE_URI || "V5_VARSAYILAN");
...
export const blockchainConfig = {
    ...
    oceanProtocolUrl: process.env.METADATA_CACHE_URI || 'https://aquarius.polygon.oceanprotocol.com',
