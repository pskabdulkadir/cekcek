...
export const blockchainConfig = {
    ...
    maxPriorityFee: process.env.MAX_PRIORITY_FEE || '45000000000', // 45 Gwei Taban Bahşiş (Savaş Modu Hızlandırma)
    gasPriceLimit: process.env.GAS_PRICE_LIMIT || '500000000000', // 500 Gwei Üst Limit (Ağ Yoğunluğu İçin Esnetildi)
