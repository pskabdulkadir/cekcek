...
export const blockchainConfig = {
    ...
    oceanProtocolUrl: process.env.OCEAN_ENDPOINT || 'https://subgraph.mainnet.oceanprotocol.com/subgraphs/name/oceanprotocol/ocean-subgraph', // DNS Bypass: Subgraph veya IPFS Gateway
